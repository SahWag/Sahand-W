...
, 'A fully motorized lower-body exoskeleton\nfor pilots with a full spinal chord injury','A task-agnostic, robot-agnostic task planner for\nROS 2 using symbolic reasoning','A robotic biped with a tail\n.'];
